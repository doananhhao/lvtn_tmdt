                    ...
                    <div class="col-md-12">
                        <div class="col-sm-6 col-md-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image">
                                    <img class="img-responsive" data-echo="{{ asset('shop/images/banners/4.jpg') }}" src="{{ asset('shop/images/blank.gif') }}" alt="">
                                </div>  
                                <div class="strip">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image">
                                    <img class="img-responsive" data-echo="{{ asset('shop/images/banners/5.jpg') }}" src="{{ asset('shop/images/blank.gif') }}" alt="">
                                </div>  
                                <div class="strip">
