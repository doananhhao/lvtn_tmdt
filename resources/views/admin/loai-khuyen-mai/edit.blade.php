                ...
                <div class="col-md-12">
                    <form action="{{ route('loai-khuyen-mai.store') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group{{ $errors->has('tenkhuyenmai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="tenkhuyenmai" class="form-control{{ $errors->has('tenkhuyenmai') ? ' form-control-danger' : '' }}" value="{{ old('tenkhuyenmai') ? old('tenkhuyenmai') : $loaikm->tenkhuyenmai }}" id="tenkhuyenmai" required="">
                        ...
                        <div class="form-group{{ $errors->has('mota') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea id="mota" name="mota" class='summernote form-control{{ $errors->has('mota') ? ' form-control-danger' : '' }}'>{!! old('mota') ? old('mota') : $loaikm->mota !!}</textarea>
                                @if ($errors->has('mota'))
