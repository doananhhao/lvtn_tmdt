                ...
                <div class="col-md-12">
                    <form action="{{ route('loai-khuyen-mai.chi-tiet-khuyen-mai.update', ['loai-khuyen-mai' => $loaikm->id, 'chi-tiet-khuyen-mai' => $ctkm->id]) }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group{{ $errors->has('giamgia') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input type="number" id="giamgia" name="giamgia" class='form-control{{ $errors->has('giamgia') ? ' form-control-danger' : '' }}' value="{{ old('giamgia') ? old('giamgia') : $ctkm->giamgia*100 }}">
                        ...
                        <div class="form-group{{ $errors->has('thoigian') || session('date_error') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-md-12">   
                                <input type="text" class="form-control{{ $errors->has('thoigian') ? ' form-control-danger' : '' }} input-daterange-timepicker" name="thoigian" value="{{ old('thoigian') ? old('thoigian') : date('d/m/Y g:i A', strtotime($ctkm->ngaybd)).' - '.date('d/m/Y g:i A', strtotime($ctkm->ngayketthuc))}}" />
